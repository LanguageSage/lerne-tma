...
DEFAULT_PROMPTS = {
    "de": """Проанализируй предложение "{phrase}". Краткий разбор слов и грамматики, затем 3 примера с тем же смыслом что и фраза с переводом на рус. Очень коротко и ясно, без лишних слов.
...
END_JSON""",
    "ru": """Переведи "{phrase}" на немецкий. Анализ только немецкого разбор слов и грамматики, 3 примера с тем же смыслом что и фраза с переводом на рус. Очень коротко и ясно, без лишних слов.
Return ONLY a JSON object in this format:
{
