export const TUTORIAL_STEPS = {
  decks: [
    ...
    { targetId: 'tut-deck-list', title: 'Твои колоды 📚', content: 'Здесь отображаются все твои наборы карточек. Набор карточек называется "Колода". Нажми на колоду, чтобы начать обучение.' },
    ...
    { targetId: 'tut-add-deck', title: 'Добавить новое ➕', content: 'Создай свою колоду, импортируй готовую из библиотеки или добавь сразу много слов через "Пакетное добавление". Все инструменты здесь!' },
  ...
  cards: [
    ...
    { targetId: 'tut-fab-add', title: 'Создай свою карточку ✍️', content: 'Самое важное! Нажми на этот плюс, чтобы создать свою собственную карточку. Ты можешь ввести слово сам или использовать магию ИИ.' }
  ],
  creator: [
