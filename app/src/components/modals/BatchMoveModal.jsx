...
import { X, Move, Folder, FolderOpen, Layers } from 'lucide-react';
      ...
      <div className="modal-backdrop glass" onClick={onClose} style={{ zIndex: 1100 }}>
        ...
        >
          ...
          <p style={{ fontSize: '0.84rem', color: '#94a3b8', margin: '0 0 12px 0' }}>
            {tr("Выберите колоду для перемещения:")}
          </p>
                  ...
                  return (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
                        <Layers size={16} style={{ color: '#a855f7', flexShrink: 0 }} />
                        <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                          <strong style={{
                            fontSize: '0.9rem',
                            color: isCurrent ? '#94a3b8' : '#f8fafc',
                            overflow: 'hidden',
                            textOverflow: 'ellipsis',
                            whiteSpace: 'nowrap'
                          }}>
                            {item.name}
                            {isCurrent && <span style={{ fontSize: '0.72rem', opacity: 0.6, marginLeft: '6px' }}>({tr("Текущая")})</span>}
                          </strong>
                      ...
                      {!isCurrent && (
                        <Move size={14} style={{ color: '#a855f7', opacity: 0.5, flexShrink: 0 }} />
                      )}
                    </button>
                  );
                }
