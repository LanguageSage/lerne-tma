...
export const FlagDE = ({ size = 20, className = "" }) => (
  <svg 
    width={size} 
...
export const FlagGB = ({ size = 20, className = "" }) => (
  <svg 
    width={size} 
    height={Math.round(size * 0.75)} 
    viewBox="0 0 640 480" 
  ...
  >
    ...
    <path fill="#C8102E" d="m424 281 216 163v36h-48L376 317l48-36zM216 199 0 36v-36h48l216 163-48 36zm208-36L640 0v36L424 199l0-36zM0 444l216-163v36L48 480H0v-36z"/>
    <path fill="#FFF" d="M240 0v480h160V0H240zM0 160v160h640V160H0z"/>
    <path fill="#C8102E" d="M272 0v480h96V0h-96zM0 192v96h640v-96H0z"/>
  </svg>
);

export const FlagNO = ({ size = 20, className = "" }) => (
  <svg 
    width={size} 
    height={Math.round(size * 0.75)} 
    viewBox="0 0 640 480" 
  ...
  >
    ...
    <path fill="#FFF" d="M160 0v480h120V0H160zM0 180v120h640V180H0z"/>
    <path fill="#00205B" d="M190 0v480h60V0h-60zM0 210v60h640v-60H0z"/>
  </svg>
);
