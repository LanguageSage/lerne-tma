...
| **Обучение, SRS & Авто-режим** | `study/StudyView.jsx`, `study/CardView.jsx`, `study/AutoplayControls.jsx`, `settings/AutoplaySettingsTab.jsx` | `useSessionStore.js`, `useSettingsStore.js`, `hooks/useAutoplay.js`, `utils/autoplaySequence.js`, `offlineApi.js` | `study.py`, `media.py` (перегенерация TTS) | `study.py`, `srs.py`, `media.py` | `TMAProgress`, `TMAReviewHistory`, `TMAMedia` |
