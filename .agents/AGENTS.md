...
4. **Verification & Evals**: Run linting (`npm --prefix app run lint`), API syntax checks, and test suites. Fix any failures before reporting to the user.
5. **Trace & Walkthrough**: Document changes, empirical test output, and key decisions in `walkthrough.md`.
