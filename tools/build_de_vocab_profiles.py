...
MAX_EXTRA = merge_groups(
    {
        "A1": [
            ...
            "farbe", "farben", "fisch", "fleisch", "fünf", "große", "grün", "hallo", "heiß", "heute", "hose", "immer",
            "jahren", "jung", "käse", "krank", "küche", "kurz", "lang", "mann", "mensch",
            "menschen", "milch", "minute", "minuten", "polizei", "rot", "salat", "schlecht",
            "sieben", "stuhl", "tisch", "vier", "wand", "warm", "wein", "zehn",
        ],
        "A2": [
        ...
        "B1": [
            ...
            "abgeordnete", "abgeordneten", "arbeitgeber", "außenminister", "außenministerin",
            "bildung", "bundeskanzler", "bundeskanzlerin", "bundesland", "bundesländer",
            "bundespräsident", "bundespräsidentin", "bundesrat", "bundesregierung",
            "bundesrepublik", "bundestag", "bürger", "bürgerinnen", "bürgermeister",
            "bürgermeisterin", "darstellung", "deutschlands", "diskutieren", "einfluss",
            "einschätzung", "empfehlen", "entstehen", "entschieden", "ergebnis", "ergebnisse",
            "erleben", "erwähnen", "europäische", "europäischen", "finanzminister",
            "finanzministerin", "gebiet", "gericht", "gesellschaft", "gemeinde", "gesetz",
            "gesetze", "gewählt", "hinweis", "innenminister", "innenministerin", "informieren",
            "inhalt", "justizminister", "justizministerin", "kirche", "kirchen", "kommunalwahl",
            "kommunalwahlen", "kritik", "landesflagge", "landeshauptstadt", "landeszentrale",
            "landkreis", "landtag", "meinungsfreiheit", "minister", "ministerin",
            "ministerpräsident", "ministerpräsidentin", "nachteil", "nachteile", "nutzen",
            "ordnungsamt", "parlament", "partei", "parteien", "persönlich", "politisch",
            "politische", "politischen", "politischer", "politisches", "premierminister",
            "premierministerin", "präsentation", "reaktion", "regierung", "regierungschef",
            "regierungschefin", "republik", "richter", "richterin", "schritt", "schritte",
            "staat", "stelle", "teilnehmen", "teilgenommen", "thema", "themen", "union",
            "ursache", "ursachen", "verbraucherzentrale", "verbessern", "vergleich",
            "vergleichen", "vorteil", "vorteile", "wahl", "wahlen", "wählen", "wappen",
            "weiterbildung", "weltkrieg", "zusammenhang",
        ],
        "B2": [
